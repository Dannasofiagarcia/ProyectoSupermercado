...
public class FechaDeLlegada implements Comparable<FechaDeLlegada> {
	 ...
	 * 
	 * @return int retorna el dia de la fecha de llegada
	 */
	public int getDia() {
		return dia;
	}
	 ...
	 * Este metodo permite obtener el dia de la fecha de llegada del producto
	 * 
	 * @param dia el nuevo dia de la fecha de llegada
	 */
	 ...
	 * 
	 * @return String el formato de la fecha de llegada
	 */
	 ...
	 * 
	 * @return int retorna la comparacion entre dos fechas
	 */
	@Override
