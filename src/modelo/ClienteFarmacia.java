...
public class ClienteFarmacia implements Comparable<ClienteFarmacia>{
	...
	public ClienteFarmacia(int id, String nombre, String apellido, String email, String genero, String pais, Image foto, String cumpleanios) {
		this.id = id;
		this.nombre = nombre;
...
/**
 * Este metodo permite obtener la fecha de cumpleanios del Cliente de la farmacia
 ...
 */
	...
	/**
	 * Este metodo permite obtener el cliente que está a la izquierda de este cliente
