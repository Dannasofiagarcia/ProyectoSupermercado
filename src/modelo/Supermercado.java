...
public class Supermercado implements Serializable {
	...
	// -----------------------------------------------------------------
	// Metodos clase cargo (�rbol n-rio)
	// -----------------------------------------------------------------

	/**
	 * Agrega un nuevo cargo al organigrama de la empresa. Si el organigrama est�
	 * vac�o, <br>
	...
	public void crearCargo(String nCargo, String nCargoJefe) throws CargoSupermercadoException {
		if (administrador == null) {
			...
			if (padre == null)
				throw new CargoSupermercadoException("Cargo inv�lido");
	...
	public void eliminarCargo(String nCargo) throws CargoSupermercadoException {
		if (administrador == null)
			throw new CargoSupermercadoException("El cargo que desea eliminar es inv�lido");
	 ...
	 * @param codigo El c�digo de identidad de la persona - ingreso!=null
	 ...
	 * @throws OrganigramaException Si el c�digo ya se encuentra asociado con otra
	 *                              persona
	 */
	public void contratarPersona(String nombre, String codigo, String turno, String nCargo)
		...
		if (temp != null)
			throw new CargoSupermercadoException("�Identidad repetida! El c�digo de cada empleado es �nico");
	 ...
	 * 
	 * @param idPersona El c�digo del empleado del que se desea el cargo -
	 *                  idPersona!=null
	 * @return El cargo de la persona con el c�digo dado. Si el empleado no existe
	 *         se retorna null
	 */
	 ...
	 * @return El cargo con el nombre dado. Si el cargo no se encontr� se retorn�
	 *         null
	 */
	...
	private void verificarInvariante() {
		...
		while (it.hasNext()) {
			...
			assert (contarOcurrenciasCargo(nomCargo) == 1) : "El nombre del cargo deber�a ser �nico";
			...
			if (e != null) {
				assert (contarOcurrenciasCodigoEmpleado(
						e.getCodigo()) == 1) : "El c�digo del empleado deber�a ser �nico";
			}
		}
	}
	...
	// -----------------------------------------------------------------
	// Metodos clientes farmacia (�rbol binario)
	// -----------------------------------------------------------------
	 ...
	 * 
	 * @return lista de contactos ordenada por orden alfab�tico. Si la lista est�
	 *         vac�a retorna null
	 */
	...
	/**
	 * Cuenta el n�mero de contactos en el directorio que tienen el nombre dado como
	 * par�metro <br>
	 ...
	 * 
	 * @param codigo  El c�digo del vuelo - c�digo >= 0 && no existe otro vuelo con
	 *                ese c�digo
	 * @param fecha   La fecha en la que se realizar� el vuelo - fecha != null y
	 ...
	 * @throws ParseException     Se lanza esta excepci�n si la fecha y hora de
	 *                            despegue no es v�lida
	 */
	public void agregarProductoSupermercado(String codigo, String nombre, double precio, String ubicacion)
		...
		if (buscarProductoSupermercado(codigo) != null) {
			throw new ProductoSupermercadoException(
					"El c�digo ingresado ya existe. Cada producto tiene un c�digo �nico");
		}
